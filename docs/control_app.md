...
Streamlit can remain available during soak, but the new app now supports the
operator actions needed for normal production except direct arbitrary-video
pipeline launch. New VOD work still enters through the queue workflow.

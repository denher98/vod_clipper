...
<head>
  ...
  <style>
    :root { color-scheme: dark; font-family: "Segoe UI", system-ui, sans-serif; background: #08111f; color: #edf3ff; }
    body { margin: 0; min-height: 100vh; display: grid; place-items: center; background: #08111f; }
    main { width: min(760px, calc(100vw - 48px)); border: 1px solid rgba(148, 163, 184, 0.22); border-radius: 18px; background: #101a29; padding: 24px; }
    h1 { margin: 0 0 8px; font-size: 1.5rem; }
    p { color: #94a3b8; line-height: 1.5; }
    pre { max-height: 360px; overflow: auto; white-space: pre-wrap; background: #07101c; color: #dbeafe; border-radius: 12px; padding: 14px; }
  </style>
</head>
<body>
  <main>

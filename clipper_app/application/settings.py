...
def _definitions() -> tuple[SettingDefinition, ...]:
    bool_keys = {
        ...
        "MODULE_VISUAL_VALIDATION_ENABLED": "modules",
        "MODULE_PRODUCT_ZOOM_ENABLED": "modules",
        "VARIANT_FFMPEG_BAKE": "render",
    }
    int_keys = {
        ...
        "VARIANTS_PER_CLIP": ("render", 1, None),
